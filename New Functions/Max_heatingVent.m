function [Max_heating, Dwelling_env_heat, Ventilation_heater] = Max_heatingVent(N0, House_Volume, Heat_recovery_ventil_annual, Total_Loss, Loss_floor, Ventilation_Type)
