...
StandBy                                                         = 0;
AppStatus.StandBy_sedentary                                     = 0;
AppStatus.StandBy_Domestic                                      = 0;
AppStatus.StandBy_seated                                        = 0;
AppStatus.tenancy                                               = 0;
...
for ij = 1:length(AppList)
    if ~isempty(AppList{ij})
        AppName = AppList{ij} ;
        [App, AppStatus] = AppState(AppName, App, Input_Data, AppStatus, myiter) ;
    end
end

%     if any(strcmp(fieldnames(App.Appliances_ConsStr),'Iron') == 1)  % ironing and vacuuming are domestic works
%         if any(strcmp(fieldnames(App.Appliances_ConsStr.Iron),Input_Data.Headers))
...
%             
%             while n == 0
%                 if App.Info.Iron(ii).(Input_Data.Headers).InUse
%                     n = 1               ;
%                     IronActive = true   ;
%                 elseif size(App.Info.Iron) == ii
%                     n = 1               ;
%                     IronActive = false  ;
%                 else
%                     ii = ii + 1         ;
...
%             end
% 
%             if IronActive % any(App.AppliancesInUse.Iron.(Input_Data.Headers))
% %                 if tenancy == 0
%                     tenancy = 1;    
% %                 end
%                 
% %                 if StandBy_Domestic == 0    
%                     StandBy_Domestic = 1;     
% %                 end  
%             end
%                     
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Iron.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Iron(4).Power * size(Input_Data.Iron,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_Domestic == 0
% %                     
% %                     StandBy_Domestic = App.Appliances_ConsStr.Iron.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Iron(4).Power * size(Input_Data.Iron,2);
% %                 
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Iron.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Iron(4).Power * 5/3 * size(Input_Data.Iron,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_Domestic == 0
% %                     
% %                     StandBy_Domestic = App.Appliances_ConsStr.Iron.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Iron(4).Power * 5/3 * size(Input_Data.Iron,2);
% %                 
% % %                     StandBy_Domestic = StandBy_Domestic + All_Var.Detail_Appliance_List.Iron(4).Power * size(Input_Data.Iron,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% %                     
% %                 end
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Iron.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Iron(4).Power * 10/3 * size(Input_Data.Iron,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_Domestic == 0
% %                     
% %                     StandBy_Domestic = App.Appliances_ConsStr.Iron.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Iron(4).Power * 10/3 * size(Input_Data.Iron,2);
% %                 
% % %                     StandBy_Domestic = StandBy_Domestic + All_Var.Detail_Appliance_List.Iron(4).Power * size(Input_Data.Iron,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% %                     
% %                 end
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Iron.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Iron'),3) * size(Input_Data.Iron,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_Domestic == 0
% %                     
% %                     StandBy_Domestic = App.Appliances_ConsStr.Iron.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Iron'),3) * size(Input_Data.Iron,2);
% %                 
% % %                     StandBy_Domestic = StandBy_Domestic + All_Var.Detail_Appliance_List.Iron(4).Power * size(Input_Data.Iron,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% %                     
% %                 end
...
%             end
%             
%             if any(App.AppliancesInUse.Vacuum.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Vacuum.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Vacuum(4).Power * size(Input_Data.Vacuum,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_Domestic == 0
% %                     
% %                     StandBy_Domestic = App.Appliances_ConsStr.Vacuum.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Vacuum(4).Power * size(Input_Data.Vacuum,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Vacuum.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Vacuum(4).Power * 5/3 * size(Input_Data.Vacuum,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_Domestic == 0
% %                     
% %                     StandBy_Domestic = App.Appliances_ConsStr.Vacuum.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Vacuum(4).Power * 5/3 * size(Input_Data.Vacuum,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Vacuum.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Vacuum(4).Power * 10/3 * size(Input_Data.Vacuum,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_Domestic == 0
% %                     
% %                     StandBy_Domestic = App.Appliances_ConsStr.Vacuum.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Vacuum(4).Power * 10/3 * size(Input_Data.Vacuum,2);
% %                                     
% %                 end
% % 
% %             case 'Self-defined'
% % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Vacuum'),3) * size(Input_Data.Vacum,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_Domestic = StandBy_Domestic + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Vacuum'),3) * size(Input_Data.Vacuum,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Vacuum.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Vacuum'),3) * size(Input_Data.Vacuum,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_Domestic == 0
% %                     
% %                     StandBy_Domestic = App.Appliances_ConsStr.Vacuum.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Vacuum'),3) * size(Input_Data.Vacuum,2);
% %                                     
% %                 end
% % 
% %                 
...
%                 end
%                 
%             if any(App.AppliancesInUse.Tele.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Tele.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Tele(4).Power * size(Input_Data.Tele,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_seated == 0
% %                     
% %                     StandBy_seated = App.Appliances_ConsStr.Tele.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Tele(4).Power * size(Input_Data.Tele,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Tele.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Tele(4).Power * 5/3 * size(Input_Data.Tele,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_seated == 0
% %                     
% %                     StandBy_seated = App.Appliances_ConsStr.Tele.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Tele(4).Power * 5/3 * size(Input_Data.Tele,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Tele.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Tele(4).Power * 10/3 * size(Input_Data.Tele,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_seated == 0
% %                     
% %                     StandBy_seated = App.Appliances_ConsStr.Tele.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Tele(4).Power * 10/3 * size(Input_Data.Tele,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
% % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Tele'),3) * size(Input_Data.Tele,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_seated = StandBy_seated + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Tele'),3) * size(Input_Data.Tele,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Tele.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Tele'),3) * size(Input_Data.Tele,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_seated == 0
% %                     
% %                     StandBy_seated = App.Appliances_ConsStr.Tele.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Tele'),3) * size(Input_Data.Tele,2);
% %                                     
% %                 end
% % 
% %                 
...
%             end
%             
%             if any(App.AppliancesInUse.Laptop.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% %                 if StandBy_seated == 0
% %                     
% %                     StandBy_seated = App.Appliances_ConsStr.Laptop.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Laptop(4).Power * size(Input_Data.Laptop,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
% %                 
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.Laptop(4).Power * 5/3 * size(Input_Data.Laptop,2); % size(App.Appliances_ConsStr.Laptop.(Input_Data.Headers),1);
...
% % %                 if tenancy == 0
% % %                    
% % %                     tenancy = App.Appliances_ConsStr.Laptop.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Laptop(4).Power * 5/3 * size(Input_Data.Laptop,2);
% % %                     
% % %                 end
% %                 
% %                 if StandBy_seated == 0
% %                     
% %                     StandBy_seated = App.Appliances_ConsStr.Laptop.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Laptop(4).Power * 5/3 * size(Input_Data.Laptop,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
% %                 
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.Laptop(4).Power * 10/3 * size(Input_Data.Laptop,2); % size(App.Appliances_ConsStr.Laptop.(Input_Data.Headers),1);
...
% % %                 if tenancy == 0
% % %                    
% % %                     tenancy = App.Appliances_ConsStr.Laptop.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Laptop(4).Power * 10/3 * size(Input_Data.Laptop,2);
% % %                     
% % %                 end
% %                 
% %                 if StandBy_seated == 0
% %                     
% %                     StandBy_seated = App.Appliances_ConsStr.Laptop.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Laptop(4).Power * 10/3 * size(Input_Data.Laptop,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
% % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Laptop'),3) * size(Input_Data.Laptop,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_seated = StandBy_seated + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Laptop'),3) * size(Input_Data.Laptop,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% % %                 if tenancy == 0
% % %                    
% % %                     tenancy = App.Appliances_ConsStr.Laptop.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Laptop'),3) * size(Input_Data.Laptop,2);
% % %                     
% % %                 end
% %                 
% %                 if StandBy_seated == 0
% %                     
% %                     StandBy_seated = App.Appliances_ConsStr.Laptop.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Laptop'),3) * size(Input_Data.Laptop,2);
% %                                     
% %                 end
% %             
% % %             case 'A or B class'
...
%             end
%             
%             if any(App.AppliancesInUse.Kettle.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% % %             case 'Self-defined'
% % % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Kettle'),3) * size(Input_Data.Kettle,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_sedentary = StandBy_sedentary + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Kettle'),3) * size(Input_Data.Kettle,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %             case 'A or B class'
% %         
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.Kettle(4).Power * size(Input_Data.Kettle,2); % size(App.Appliances_ConsStr.Kettle.(Input_Data.Headers),1);
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Kettle.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Kettle(4).Power * size(Input_Data.Kettle,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Kettle.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Kettle(4).Power * size(Input_Data.Kettle,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Kettle.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Kettle(4).Power * 5/3 * size(Input_Data.Kettle,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Kettle.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Kettle(4).Power * 5/3 * size(Input_Data.Kettle,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Kettle.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Kettle(4).Power * 10/3 * size(Input_Data.Kettle,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Kettle.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Kettle(4).Power * 10/3 * size(Input_Data.Kettle,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Kettle.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Kettle'),3) * size(Input_Data.Kettle,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Kettle.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Kettle'),3) * size(Input_Data.Kettle,2);
% %                                     
% %                 end
% % 
% %                 
...
%             end
%             
%             if any(App.AppliancesInUse.MW.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% % %             case 'Self-defined'
% % % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'MW'),3) * size(Input_Data.MW,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_sedentary = StandBy_sedentary + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'MW'),3) * size(Input_Data.MW,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %             case 'A or B class'
% %         
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.MW(4).Power * size(Input_Data.MW,2); % size(App.Appliances_ConsStr.MW.(Input_Data.Headers),1);
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.MW.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.MW(4).Power * size(Input_Data.MW,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.MW.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.MW(4).Power * size(Input_Data.MW,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.MW.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.MW(4).Power * 5/3 * size(Input_Data.MW,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.MW.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.MW(4).Power * 5/3 * size(Input_Data.MW,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.MW.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.MW(4).Power * 10/3 * size(Input_Data.MW,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.MW.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.MW(4).Power * 10/3 * size(Input_Data.MW,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.MW.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'MW'),3) * size(Input_Data.MW,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.MW.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'MW'),3) * size(Input_Data.MW,2);
% %                                     
% %                 end
% % 
% %                 
...
%             end
%             
%             if any(App.AppliancesInUse.Coffee.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% % %             case 'Self-defined'
% % % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Coffee'),3) * size(Input_Data.Coffee,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_sedentary = StandBy_sedentary + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Coffee'),3) * size(Input_Data.Coffee,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %             case 'A or B class'
% %         
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.Coffee(4).Power * size(Input_Data.Coffee,2); % size(App.Appliances_ConsStr.Coffee.(Input_Data.Headers),1);
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Coffee.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Coffee(4).Power * size(Input_Data.Coffee,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Coffee.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Coffee(4).Power * size(Input_Data.Coffee,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Coffee.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Coffee(4).Power * 5/3 * size(Input_Data.Coffee,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Coffee.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Coffee(4).Power * 5/3 * size(Input_Data.Coffee,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Coffee.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Coffee(4).Power * 10/3 * size(Input_Data.Coffee,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Coffee.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Coffee(4).Power * 10/3 * size(Input_Data.Coffee,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Coffee.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers){strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(:,1), 'Coffee maker'),3} * size(Input_Data.Coffee,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Coffee.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers){strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Coffee maker'),3} * size(Input_Data.Coffee,2);
% %                                     
% %                 end
% % 
% %                 
...
%             end
%             
%             if any(App.AppliancesInUse.Toas.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% % %             case 'Self-defined'
% % % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Toas'),3) * size(Input_Data.Toas,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_sedentary = StandBy_sedentary + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Toas'),3) * size(Input_Data.Toas,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %             case 'A or B class'
% %         
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.Toas(4).Power * size(Input_Data.Toas,2); % size(App.Appliances_ConsStr.Toas.(Input_Data.Headers),1);
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Toas.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Toas(4).Power * size(Input_Data.Toas,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Toas.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Toas(4).Power * size(Input_Data.Toas,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Toas.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Toas(4).Power * 5/3 * size(Input_Data.Toas,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Toas.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Toas(4).Power * 5/3 * size(Input_Data.Toas,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Toas.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Toas(4).Power * 10/3 * size(Input_Data.Toas,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Toas.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Toas(4).Power * 10/3 * size(Input_Data.Toas,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Toas.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Toas'),3) * size(Input_Data.Toas,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Toas.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Toas'),3) * size(Input_Data.Toas,2);
% %                                     
% %                 end
% % 
% %                 
...
%             end
%             
%             if any(App.AppliancesInUse.Waff.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% % %             case 'Self-defined'
% % % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Waff'),3) * size(Input_Data.Waff,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_sedentary = StandBy_sedentary + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Waff'),3) * size(Input_Data.Waff,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %             case 'A or B class'
% %         
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.Waff(4).Power * size(Input_Data.Waff,2); % size(App.Appliances_ConsStr.Waff.(Input_Data.Headers),1);
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Waff.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Waff(4).Power * size(Input_Data.Waff,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Waff.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Waff(4).Power * size(Input_Data.Waff,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Waff.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Waff(4).Power * 5/3 * size(Input_Data.Waff,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Waff.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Waff(4).Power * 5/3 * size(Input_Data.Waff,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Waff.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Waff(4).Power * 10/3 * size(Input_Data.Waff,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Waff.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Waff(4).Power * 10/3 * size(Input_Data.Waff,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Waff.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Waff'),3) * size(Input_Data.Waff,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Waff.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Waff'),3) * size(Input_Data.Waff,2);
% %                                     
% %                 end
% % 
% %         end
...
%             end
%             
%             if any(App.AppliancesInUse.Stereo.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% % %             case 'Self-defined'
% % % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Stereo'),3) * size(Input_Data.Stereo,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_sedentary = StandBy_sedentary + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Stereo'),3) * size(Input_Data.Stereo,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %             case 'A or B class'
% %         
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.Stereo(4).Power * size(Input_Data.Stereo,2); % size(App.Appliances_ConsStr.Stereo.(Input_Data.Headers),1);
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Stereo.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Stereo(4).Power * size(Input_Data.Stereo,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Stereo.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Stereo(4).Power * size(Input_Data.Stereo,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Stereo.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Stereo(4).Power * 5/3 * size(Input_Data.Stereo,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Stereo.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Stereo(4).Power * 5/3 * size(Input_Data.Stereo,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Stereo.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Stereo(4).Power * 10/3 * size(Input_Data.Stereo,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Stereo.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Stereo(4).Power * 10/3 * size(Input_Data.Stereo,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Stereo.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Stereo'),3) * size(Input_Data.Stereo,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Stereo.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Stereo'),3) * size(Input_Data.Stereo,2);
% %                                     
% %                 end
% % 
% %                 
...
%             end
%             
%             if any(App.AppliancesInUse.Hair.(Input_Data.Headers)) == 1
%                 
%                 if tenancy == 0
%                 
%                     tenancy = 1;
...
% % %             case 'Self-defined'
% % % 
% % %                 StandBy = StandBy + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Hair'),3) * size(Input_Data.Hair,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % %                 StandBy_sedentary = StandBy_sedentary + All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Hair'),3) * size(Input_Data.Hair,2); % size(App.Appliances_ConsStr.Iron.(Input_Data.Headers),1);
% % 
% %             case 'A or B class'
% %         
% % %                 StandBy = StandBy + All_Var.Detail_Appliance_List.Hair(4).Power * size(Input_Data.Hair,2); % size(App.Appliances_ConsStr.Hair.(Input_Data.Headers),1);
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Hair.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Hair(4).Power * size(Input_Data.Hair,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Hair.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Hair(4).Power * size(Input_Data.Hair,2);
% %                                     
% %                 end
% %                 
% %             case 'C or D class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Hair.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Hair(4).Power * 5/3 * size(Input_Data.Hair,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Hair.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Hair(4).Power * 5/3 * size(Input_Data.Hair,2);
% %                                     
% %                 end
% %                 
% %             case 'E or F class'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Hair.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Hair(4).Power * 10/3 * size(Input_Data.Hair,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Hair.(Input_Data.Headers)(myiter+1) > All_Var.Detail_Appliance_List.Hair(4).Power * 10/3 * size(Input_Data.Hair,2);
% %                                     
% %                 end
% %                 
% %             case 'Self-defined'
...
% %                 if tenancy == 0
% %                    
% %                     tenancy = App.Appliances_ConsStr.Hair.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Hair'),3) * size(Input_Data.Hair,2);
% %                     
% %                 end
% %                 
% %                 if StandBy_sedentary == 0
% %                     
% %                     StandBy_sedentary = App.Appliances_ConsStr.Hair.(Input_Data.Headers)(myiter+1) > All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers)(strcmp(All_Var.GuiInfo.SelfDefinedAppliances.(Input_Data.Headers), 'Hair'),3) * size(Input_Data.Hair,2);
% %                                     
% %                 end
% % 
% %                 
...
if Inhabitants == 1
    if timehour > 22 || timehour < 8
        ...
        Met_rate            = 46; 
    elseif AppStatus.tenancy == 1 && AppStatus.StandBy_Domestic == 1 %App.OccupancyDetection.Domestic_Work1.(Input_Data.Headers) > StandBy_Domestic
        People_Heat_Gain    = Inhabitants * Domestic_Work;
        Met_rate            = 116;
    elseif AppStatus.tenancy == 1 && AppStatus.StandBy_seated == 1 %(App.OccupancyDetection.Tele.(Input_Data.Headers) + App.OccupancyDetection.Laptop.(Input_Data.Headers)) > StandBy_seated 
        People_Heat_Gain    = Inhabitants * Seated;
        Met_rate            = 58;
    elseif AppStatus.tenancy == 1 
    ...
    if timehour > 22 || timehour < 8
        People_Heat_Gain    = Inhabitants * Sleeping;
        Met_rate            = 46;
    elseif AppStatus.tenancy == 1 && AppStatus.StandBy_Domestic == 1 && AppStatus.StandBy_seated == 1 %App.OccupancyDetection.Domestic_Work1.(Input_Data.Headers) > StandBy_Domestic && (App.OccupancyDetection.Tele.(Input_Data.Headers) + App.OccupancyDetection.Laptop.(Input_Data.Headers)) > StandBy_seated
        People_Heat_Gain    = (Inhabitants - 1) * Seated + Domestic_Work;
        Met_rate            = 116;
    elseif AppStatus.tenancy == 1 && AppStatus.StandBy_Domestic == 1 && AppStatus.StandBy_sedentary == 1 %App.OccupancyDetection.Domestic_Work1.(Input_Data.Headers) > StandBy_Domestic && SedentaryActivityDetection == 1 %&& any((NewVar.Appliances_Cons(BuildSim,myiter+1,find(nbr_appliances(:,2) ~= DomesticWork1 && nbr_appliances(:,2) ~= Tele && nbr_appliances(:,2) ~= Laptop && nbr_appliances(:,2) ~= Elecheat)) > 0) == 1)
    ...
    elseif AppStatus.tenancy == 1 && AppStatus.StandBy_seated == 1 %(App.OccupancyDetection.Tele.(Input_Data.Headers) + App.OccupancyDetection.Laptop.(Input_Data.Headers)) > StandBy_seated
        People_Heat_Gain    = Inhabitants * Seated;
        Met_rate            = 58;
    elseif AppStatus.tenancy == 1 && AppStatus.StandBy_sedentary == 1 %SedentaryActivityDetection == 1
        People_Heat_Gain    = Inhabitants * Sedentary_activity;
        Met_rate            = 70;
    else 
        People_Heat_Gain    = 0;
