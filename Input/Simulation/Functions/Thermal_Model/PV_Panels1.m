...
function [Power] = PV_Panels1(Global_Irr, Sunrise, Sunset, Time_Sim, Input_Data, Temperature,Housenbr,n)

myiter = Time_Sim.myiter;
if n > 0
    timehour = Time_Sim.timehour(n);
else
...
% Original above and adjusted below
